...
import StaffConsents from "./StaffConsents";
import StaffOpInstructions from "./StaffOpInstructions";
import StaffQuickPhrases from "./StaffQuickPhrases";

const VALID = new Set(["consents", "pre-op", "post-op", "quick-phrases", "protocols"]);

export default function StaffClinicalTemplates() {
