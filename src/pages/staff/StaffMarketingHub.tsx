...
import StaffPerks from "./StaffPerks";
import StaffPosConfig from "./StaffPosConfig";
import StaffNewsletter from "./StaffNewsletter";

const VALID = new Set(["newsletter", "campaigns", "perks", "discounts"]);

export default function StaffMarketingHub() {
  ...
  return (
    <div className="p-4 sm:p-6 max-w-6xl mx-auto">
      ...
      >
        ...
        <TabsContent value="discounts" className="mt-4"><StaffPosConfig /></TabsContent>
      </Tabs>
    </div>
  );
}
